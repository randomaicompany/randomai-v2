  ...
  <div class="p-4 mt-4 border-2 border-gray-400 border-dashed">
    ...
    {:else}
      <p
        ...
        class="overflow-hidden text-xl text-gray-400"
      >
  ...
  <form on:submit|preventDefault={addText}>
    <div class="relative flex-1">
      <textarea
        ...
        class="min-w-[256px] resize-none py-4 font-normal border-gray-400 md:text-sm text-base border outline-none focus:border px-4 w-full"
      ></textarea>
