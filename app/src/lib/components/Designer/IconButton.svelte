...
<button
  on:click
  class="relative flex items-center justify-center w-8 h-8 transition-all bg-white border rounded-full outline-none group hover:bg-gray-100 active:bg-gray-200 {className}">
