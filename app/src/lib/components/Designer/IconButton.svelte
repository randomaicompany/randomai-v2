...
<button
  ...
  class="group relative flex h-8 w-8 items-center justify-center rounded-full border bg-white outline-hidden transition-all hover:border-brand-accent hover:bg-brand-accent hover:text-white active:bg-gray-200 {className}">
...
<button
  on:click
  class="relative flex items-center justify-center w-8 h-8 transition-all bg-white border rounded-full outline-hidden group hover:bg-brand-accent hover:border-brand-accent hover:text-white active:bg-gray-200 {className}">
  <i class="material-symbols-rounded text-xl!">{iconName}</i>
